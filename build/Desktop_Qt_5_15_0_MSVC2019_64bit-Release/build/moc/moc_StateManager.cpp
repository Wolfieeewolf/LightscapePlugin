...
QT_MOC_LITERAL(3, 27, 11), // "PluginState"
QT_MOC_LITERAL(4, 39, 8), // "newState"
QT_MOC_LITERAL(5, 48, 14), // "enabledChanged"
QT_MOC_LITERAL(6, 63, 7), // "enabled"
QT_MOC_LITERAL(7, 71, 13), // "errorOccurred"
QT_MOC_LITERAL(8, 85, 5) // "error"

    },
    "StateManager\0stateChanged\0\0PluginState\0"
    "newState\0enabledChanged\0enabled\0"
...
void StateManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->stateChanged((*reinterpret_cast< PluginState(*)>(_a[1]))); break;
        ...
        {
            using _t = void (StateManager::*)(PluginState );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StateManager::stateChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (StateManager::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StateManager::enabledChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (StateManager::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StateManager::errorOccurred)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void StateManager::stateChanged(PluginState _t1)
{
...
// SIGNAL 1
void StateManager::enabledChanged(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void StateManager::errorOccurred(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
